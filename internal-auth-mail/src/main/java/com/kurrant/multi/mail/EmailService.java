...
import com.kurrant.multi.RedisUtil;
...
public class EmailService {
    ...
    public MimeMessage createMessage(String to)throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("[커런트] 회원가입 인증 코드: "); //메일 제목
        ...
        message.setFrom(new InternetAddress(id,"kurrant")); //보내는 사람의 메일 주소, 보내는 사람 이름
    ...
    public String sendSimpleMessage(String to)throws Exception {
        ...
        try{
            redisUtil.setDataExpire(ePw, to, 300 * 1L);
